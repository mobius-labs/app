...
describe("Access Account integration tests", () => {
    ...
    it("Lets non-user sign up to Mobius", () => {
        ...
        cy.get(".level-right > .dropdown > .dropdown-trigger").click();

        cy.get(
            ".level-right > .dropdown > .dropdown-content > .dropdown-item"
        ).click();
    });

    it("Lets user log in with credentials", () => {
        cy.visit("/");
        ...
        // cy.get('.level-right > .dropdown > .dropdown-trigger').click()
        //
        // cy.get('.level-right > .dropdown > .dropdown-content > .dropdown-item').click()
    });
});
